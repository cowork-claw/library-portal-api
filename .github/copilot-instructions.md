...
- **Index Caching:** Cache frequently-used derived views (like sorted URL lists) as immutable `tuple`s and `types.MappingProxyType` to avoid repeated sorting and prevent accidental mutation.
