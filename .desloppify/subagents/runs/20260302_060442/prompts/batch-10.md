...
Files assigned:
- app_v2/__init__.py
- app_v2/data_loader.py
- app_v2/main.py
- app_v2/middleware/__init__.py
- app_v2/middleware/auth.py
- app_v2/middleware/metrics.py
- app_v2/middleware/security.py
- app_v2/models.py
- app_v2/routes/__init__.py
- app_v2/routes/health.py
- app_v2/routes/metadata.py
- app_v2/routes/metrics.py
- app_v2/routes/papers.py
- app_v2/services/__init__.py
- app_v2/services/indexing.py
- app_v2/services/search.py
- app_v2/utils.py
- config/__init__.py
- config/config_v2.py
- scraper/library_scraper/__init__.py
- scraper/library_scraper/items.py
- scraper/library_scraper/middlewares.py
- scraper/library_scraper/settings.py
- scraper/library_scraper/spiders/__init__.py
- scraper/library_scraper/spiders/question_papers_enhanced.py
- scraper/scrape_log.py
- scraper/scraper_config.py
- scripts/add_program_abbrev.py
- scripts/benchmarks/benchmark_search.py
- scripts/benchmarks/benchmark_year_filter.py
- scripts/processing/__init__.py
- scripts/processing/paper_categorizer.py
- scripts/processing/run_categorizer.py
- scripts/processing/staging_handler.py
- scripts/processing/validate_data.py
