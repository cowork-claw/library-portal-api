...
async def health_check():
    ...
    data_status = ComponentHealth(
        ...
        message=f"Loaded {paper_index.total_papers} papers" if data_healthy else "No papers loaded",
...
def _check_staging_health() -> ComponentHealth:
    ...
    try:
        ...
        return ComponentHealth(
            status="degraded",
            message=f"Error reading staging file: {e}",
            details=None
        )
